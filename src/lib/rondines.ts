...
import { getValidToken } from "./login/get-valid-token";
    ...
    export const getBitacoraById= async (record_id: string)=> {
        ...
        export const asignarRecorrido= async (folio: string,asignado:any[])=> {
        const payload = {
            folio,
            asignado_a:asignado,
            option: "asignar_recorrido",
            script_name: "rondines.py",
        };
    ...
    export const catalogoGrupoRecorridos= async ()=> {
        const payload = {
            option: "catalago_grupos_recorridos",
            script_name: "rondines.py",
        };
