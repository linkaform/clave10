...
export const crearIncidencia = async (
  data_incidence: InputIncidencia | null,
) => {
  const payload = {
    data_incidence,
...
export const editarIncidencia = async (
  data_incidence_update: InputIncidencia | null,
  folio: string,
) => {
  const payload = {
...
export const crearSeguimientoIncidencia = async (
  seguimientos_incidencia: any[],
  folio: string,
  estatus: string,
) => {
