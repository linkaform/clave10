...
import { cn, formatDateToString, formatFecha, isExcluded, normalizeText, prefijoToCountry } from "@/lib/utils";
...
const PaseEntradaPage = () => {
  ...
  useEffect(() => {
    ...
    const requisito = grupoRequisitos.find((r) => normalizeText(r.ubicacion) === normalizeText(ubicacionNombre));
