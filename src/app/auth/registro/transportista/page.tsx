...
const formSchema = z
  .object({
    ...
    empresaTransporte: z.string().min(1, "La empresa de transporte es requerida"),
        ...
        <CardContent className="flex flex-col items-center px-12 py-10">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-4">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        {...field}
                        placeholder="Ej. Roberto Hernández Martínez"
              ...
              {/* EMPRESA DE TRANSPORTE + NÚMERO DE LICENCIA */}
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FieldLabel required>Empresa de Transporte</FieldLabel>
                      <FormControl>
                        <Input
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FieldLabel required>Número de Licencia</FieldLabel>
                      <FormControl>
                        <Input
                          {...field}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          type="email"
                          placeholder="Ej. roberto@transporte.com"
                          className={inputClass}
                        />
                      </FormControl>
                      <FormMessage />
