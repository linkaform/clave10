...
const formSchema = z
  .object({
    ...
    puestoTrabajo: z.string().min(1, "El puesto de trabajo es requerido"),
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Ej. Juan Pérez García" className={inputClass} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Ej. juanperez" className={inputClass} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} type="email" placeholder="Ej. correo@ejemplo.com" className={inputClass} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Ej. Administración" className={inputClass} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FieldLabel required>Puesto de Trabajo</FieldLabel>
                      <FormControl>
                        <Input {...field} placeholder="Ej. Gerente General" className={inputClass} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="Ej. Empresa S.A. de C.V." className={inputClass} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
