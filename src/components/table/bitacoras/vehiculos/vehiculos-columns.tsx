...
export const vehiculosColumns: ColumnDef<Bitacora_record>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="capitalize">{veh?.modelo_vehiculo}</div>;
    },
    enableSorting: true,
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const veh = row.original.vehiculos[0];
      return <div className="capitalize">{veh?.marca_vehiculo}</div>;
    },
    enableSorting: true,
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const veh = row.original.vehiculos[0];
      return <div className="capitalize">{veh?.color}</div>;
    },
    enableSorting: true,
  },
  {
    ...
    cell: ({ row }) => {
      const veh = row.original.vehiculos[0];
      return <div className="capitalize">{veh?.nombre_estado}</div>;
    },
    enableSorting: true,
  },

  {
    ...
    cell: ({ row }) => {
      const veh = row.original.vehiculos[0];
      return <div className="capitalize">{veh?.placas}</div>;
    },
    enableSorting: true,
  },
];
