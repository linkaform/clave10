...
interface PaginationTransportistasProps {
  actual_page: number;
...
const PaginationTransportistas: React.FC<PaginationTransportistasProps> = ({
  actual_page,
  records_on_page,
  total_pages,
  total_records,
  ...
  return (
    <div className="flex items-center gap-4 w-full justify-between border rounded-md p-3 mt-2">
...
export default PaginationTransportistas;
