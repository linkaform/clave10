...
interface ConcesionadosDetallesDevolucionProps {
  title: string;
...
export const ConcesionadosDetallesDevolucion: React.FC<ConcesionadosDetallesDevolucionProps> = ({
  title,
  data,
  children,
  setIsSuccess,
      ...
      <DialogContent className="max-w-lg overflow-scroll"  onInteractOutside={(e) => e.preventDefault()} >
        ...
        <div className="grid grid-cols-2 gap-6">
            ...
            <p className="font-bold">
                Categoría: <span className="font-normal">Herramientas</span>
            </p>
            </div>

            <div className="w-full flex gap-2">
            <p className="font-bold">
                Equipo: <span className="font-normal">Martillo</span>
            </p>
            </div>

            <div className="col-span-2 w-full flex gap-2">
            <p className="font-bold">
                Unidades: <span className="font-normal">x3</span>
            </p>
            </div>

            <div className="w-full flex gap-2">
            <p className="font-bold text-blue-500 ">
                Precio Unitario($) <span className="font-normal">$15</span>
            </p>
            </div>
            <div className="w-full flex gap-2">
            <p className="font-bold  text-blue-500 ">
                Subtotal($) <span className="font-normal">$45</span>
            </p>
            </div>
            ...
            <div className="w-full flex gap-2">
            <p className="font-bold">
                Comentario: <span className="font-normal">Pruebas de articulos concesionados</span>
            </p>
            </div>
