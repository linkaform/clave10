...
interface ConcesionadosDetallesConcesionProps {
  title: string;
...
export const ConcesionadosDetallesConcesion: React.FC<ConcesionadosDetallesConcesionProps> = ({
  title,
  data,
  children,
  setIsSuccess,
    ...
    <Dialog open={isSuccess}  onOpenChange={setIsSuccess}>
      ...
      <DialogContent className="max-w-lg overflow-scroll"  onInteractOutside={(e) => e.preventDefault()} >
        ...
        <div className="grid grid-cols-2 gap-6">
            ...
            <p className="font-bold">
                Unidades: <span className="font-normal">x10</span>
            </p>
            </div>

            <div className="w-full flex gap-2">
            <p className="font-bold text-blue-500 ">
                Precio Unitario($) <span className="font-normal">$200</span>
            </p>
            </div>
            <div className="w-full flex gap-2">
            <p className="font-bold  text-blue-500 ">
                Subtotal($) <span className="font-normal">$20,000</span>
            </p>
            </div>
            ...
            <div className="w-full flex gap-2">
            <p className="font-bold">
                Comentario: <span className="font-normal">Este es un comentario de prueba</span>
            </p>
            </div>
