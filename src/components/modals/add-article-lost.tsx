                      ...
                      <Select
                        ...
                        <SelectContent>
                          {dataArticulos?.length > 0 ? (
                            ...
                            <>
                              <SelectItem disabled value={"no opciones"}>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        ...
                        <SelectTrigger className="w-full">
                          {loadingUbicaciones ? (
                            <SelectValue placeholder="Cargando ubicaciones..." />
                          ) : (
                ...
                <>
                  <FormField
                    ...
                    render={({ field }: any) => (
                      <FormItem>
                        <FormLabel className="">
                          <span className="text-red-500"></span> Quien entrega
                          Externo:
                        </FormLabel>{" "}
                        <FormControl>
                          <Input
                            placeholder="Quien entrega Interno"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        ...
                        <SelectContent>
                          {responseGetLockers ? (
                            responseGetLockers.map((locker: any) => (
                              <SelectItem key={locker._id} value={locker._id}>
                                {locker.locker_id} - {locker.area}
                              </SelectItem>
                            ))
                          ) : (
                            <SelectItem value={"__no_lockers__"} disabled>
