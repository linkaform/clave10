...
export const EditarIncidenciaModal: React.FC<EditarIncidenciaModalProps> = ({
	...
	const { dataAreas:areas, dataLocations:ubicaciones,} = useCatalogoPaseAreaLocation(ubicacionSeleccionada, modalEditarAbierto,  location?true:false, { uso: "incidencias" });
