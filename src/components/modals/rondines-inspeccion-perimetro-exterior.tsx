...
export const ViewRondinesDetallePerimetroExt: React.FC<ViewRondinesDetalleAreaProps> = ({
    ...
    const estatus = selectedRondin?.resumen?.find((item: { dia: number }) => item.dia === diaSeleccionado)?.estado;
    ...
    return (
        <div className="overflow-y-auto h-[550px]">
            <div className="sticky top-0 z-20 bg-white py-2 border-b">
            ...
            <div className="flex-1 overflow-y-auto h-[550px] px-2">
                {view === "lista" && (
                    <>
            ...
            <div className="sticky bottom-0 z-20 bg-white py-1 border-t text-center">
