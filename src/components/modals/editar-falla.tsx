...
export const EditarFallaModal: React.FC<EditarFallaModalProps> = ({
	...
	const { dataAreas:areas, dataLocations:ubicaciones, isLoadingAreas:loadingAreas} = useCatalogoPaseAreaLocation(ubicacionSeleccionada, true,  ubicacionSeleccionada?true:false, { uso: "fallas" });
