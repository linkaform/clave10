...
const formSchema = z.object({
  ...
  foto_equipo: z.array(z.any()).optional().default([]),
});

export const EqipmentLocalPassModal: React.FC<Props> = ({
  title,
  children,
  equipos,
  setEquipos,
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <ScanBarcodeModal
                        ...
                        setOpen={setOpenScan}
                        onScan={(code: any) =>
                          field.onChange(code.toUpperCase())
                        }
                      />
                    </FormItem>
                  )}
